...
<?php echo IndexTitleWidget::widget(); ?>
        <div class="m-content">
            ...
            <?php echo Html::beginForm(['edit'], 'post', array('id' => 'formdata','role'=>'form'));?>
            ...
            <div class="pt15 pb30">
                ...
                <div class="form-horizontal pl10">
                    <div class="form-group">
                        ...
                        <div class="control-input pl-control-input"><input name="account" type="text" class="form-control w200" value="<?php echo $model['account'];?>"></div>
                    </div>
                    <div class="form-group">
                        <label class="control-label text-right">账号名称</label>
                        <div class="control-input pl-control-input"><input name="name" type="text" class="form-control w200" value="<?php echo $model['name'];?>"></div>
                    </div>
                </div>
            </div>
                ...
                <div class="tree_account pl30 js-treeAccount">
                    <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    <label><input name="right[]" value="<?php echo RIGHT_ORDER;?>" <?php if(in_array(RIGHT_ORDER,$right)){echo 'checked';}?> type="checkbox" class="qkj-checkbox"> 全部订单</label>
                                </li>
                            </ul>
                        </li>
                        <li>
...
<script>
    ...
    $().ready(function() {
        ...
        messages: {
            ...
            name: {
                required: "请输入账号名称",
                maxlength: "账号名称长度不能大于{0}",
            },
            pwd: {
                required: "请输入密码",
                rangelength: "密码长度为5-16位",
            },
        },
            ignore: ''
    })
